<?php
	...
	{
		$q = "SELECT * FROM `restaurants` WHERE `resEmail` = '$_POST[email]' AND `resPass` = SHA1('$_POST[password]')";
...
<body>
	...
	<div id="center_maker">
		...
		<div id="restLogin">
			<form action="restlogin.php" method="POST">
			...
			Don't have an account? <a href="restroRegister.php">Register here</a>
		</div>
	</div>
</body>
</html>
